        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string insertQuery = "INSERT INTO PHIEUMUON(MAPM, MADOCGIA, MASACH, MATHUTHU, NGAYMUON, NGAYHENTRA, TRANGTHAI) VALUES (@maPM, @madocgia, @masach, @mathuthu, @ngaymuon, @ngayhentra, @trangthai)";
                    using (SqlCommand command = new SqlCommand(insertQuery, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@ngaymuon", dateMuonSach.Value);
                ...
                dateMuonSach.Value = DateTime.Now;
        ...
        private void tablePM_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0 && e.RowIndex < tablePM.Rows.Count - 1)
                {
                    ...
                    dateMuonSach.Value = ngayMuon != DateTime.MinValue ? ngayMuon : DateTime.Now;
